...
\geometry{a4paper, top=0.75cm, left=0.75cm, right=0.75cm, bottom=1.0cm}
...
\mdfdefinestyle{titre1}{backgroundcolor=veryLightGray}
\mdfdefinestyle{cadreCompetences}{backgroundcolor=veryLightGray, shadow=true, shadowcolor=black, 
          linewidth=0pt, linecolor=red, shadowsize=6.5pt, leftmargin=0pt, rightmargin=0pt, innerrightmargin=5pt}
    ...
    \begin{mdframed}[style=cadreCompetences]
        ...
        \begin{itemize}
            \item{Solidworks
                    ...
                    \includegraphics[scale=0.20]{img/star.png} \hspace{-0.2cm}
                    \includegraphics[scale=0.20]{img/star.png} \hspace{-0.2cm}
                    \includegraphics[scale=0.20]{img/half_star.png}}
            \item{UG NX
                    \hfill
                    \includegraphics[scale=0.20]{img/star.png} \hspace{-0.2cm}
                    \includegraphics[scale=0.20]{img/star.png} \hspace{-0.2cm}
